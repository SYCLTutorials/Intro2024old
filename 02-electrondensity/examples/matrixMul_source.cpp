    ...
    try {
        ...
        gpuQueue.submit([&](sycl::handler& cgh) {
            ...
            cgh.parallel_for<matrix_multiply>(sycl::range{N, N}, [=](sycl::id<2> idx) {
                // The computation for matrix multiplication should be implemented here
            });
        }).wait();
        ...
        // Ensure to include buffer allocation, accessor creation, and the parallel_for implementation
